...
(@Cat_General, N'The word “algorithm” traces to the mathematician al-Khwarizmi; medieval Latin renderings of his name became “algorismus/algorithmus.”', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The first adhesive postage stamp was Britain''s Penny Black, issued in 1840.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The International Date Line zigzags to keep island groups and countries on the same calendar day.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Prime Meridian at Greenwich was adopted internationally in 1884 for standard longitudes and timekeeping.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'A-series paper sizes (A0, A1, A2… A4) keep the same √2 aspect ratio; A4 is 210×297 mm.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Olympic marathon distance was standardized at 42.195 km after the 1908 London Games route.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Michelin stars began as part of a tire company''s travel guides to encourage motoring.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Post-it Notes resulted from pairing a very weak, pressure-sensitive adhesive with paper — a “failed” super-glue turned useful.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Statue of Liberty''s green color is a patina on thin copper sheets (about 2–3 mm) over an iron frame.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Panama Canal uses a system of locks to lift ships roughly 26 meters to Gatún Lake, then back down.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The 1883 Krakatoa eruption was so loud pressure waves circled the Earth multiple times.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'In a double rainbow the secondary arc has its colors reversed compared with the primary.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The sky appears blue due to Rayleigh scattering; at sunset longer paths through air scatter blue away, leaving reds and oranges.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Magenta isn’t a single-wavelength spectral color; it''s a perception from the brain bridging red and violet.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Polarized sunglasses cut glare by filtering horizontally polarized light reflected from water, roads, and snow.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Jet lag often feels worse when flying east because most human body clocks naturally run slightly longer than 24 hours.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Microwave ovens commonly operate around 2.45 GHz and heat food by dielectric losses in polar molecules like water.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'“Wi-Fi” is a coined brand name — it does not literally stand for “wireless fidelity.”', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Credit-card numbers include a Luhn checksum digit to catch common entry errors.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The International System of Units (SI) has seven base units: m, kg, s, A, K, mol, and cd.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Since 2019 the kilogram is defined by fixing the value of Planck’s constant h, not by a metal prototype.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The metre is defined via the speed of light: the distance light travels in vacuum in 1/299,792,458 of a second.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The second is defined by 9,192,631,770 transitions of the cesium-133 atom''s hyperfine levels.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The U.S.–Canada border is the world’s longest international land border.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Caspian Sea is the largest lake by surface area, despite its name.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Memory trick: stalactites cling to the ceiling; stalagmites grow upward from the ground.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'On standard dice, opposite faces sum to seven (1–6, 2–5, 3–4).', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Eight perfect “out-shuffles” of a 52-card deck return it to original order.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Vikings did not wear horned helmets; that image comes from 19th-century opera costumes.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Bulls are dichromats; it''s the movement of the cape, not the red color, that provokes them.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'“Venomous” means an animal injects toxin (e.g., via fangs or stingers); “poisonous” means toxin is harmful if eaten or touched.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Periodical cicadas emerge on 13- or 17-year cycles — prime numbers that reduce overlap with predators.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The largest organism by area may be an Armillaria “humongous fungus” spanning several square kilometers in Oregon.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Great Basin bristlecone pines can live for nearly five millennia, among the oldest known trees.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Autumn leaf colors appear as chlorophyll breaks down, revealing carotenoids and anthocyanins.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'AM and PM stand for ante meridiem and post meridiem — before and after midday.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Many Arabic scripts are written right-to-left, but numerals are typically written left-to-right.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The $ symbol likely evolved from a ligature of “PS,” an abbreviation for the Spanish peso.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'“Big Ben” is actually the nickname of the Great Bell; the tower is officially Elizabeth Tower.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Lead’s chemical symbol Pb comes from Latin plumbum — the root of “plumbing.”', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Tungsten’s chemical symbol W comes from “wolfram,” historically used for the element.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'“OK” gained popularity in 1839 from a newspaper joke about “oll korrect”; its exact origin has multiple tales.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The alphabet used in English descends from the Phoenician script via Greek and Latin, with Greek adding explicit vowels.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Lunisolar calendars add leap months because twelve lunar months are about 11 days shorter than a solar year.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Gregorian calendar (1582) refined leap-year rules to correct drift; countries adopted it at different times.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Many clock faces use IIII instead of IV for 4, for visual symmetry and tradition.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Mandarin Chinese has the largest number of native speakers of any language.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'In chess setup, each queen starts on a square of her own color — “queen on her color.”', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Western pianos are tuned (typically) in 12-tone equal temperament, spacing semitones evenly across the octave.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'Gauss proved a regular 17-gon is constructible with straightedge and compass — a rare non-trivial example.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Library of Congress is the largest library in the world by collection size.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'The Maillard reaction (amino acids + sugars) creates browned flavours; caramelisation is sugar‑only.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'MSG provides umami by activating glutamate receptors; it is widely recognized as safe for most people.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Wheat gluten forms elastic networks that trap gas; kneading develops gluten, resting relaxes it.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Sourdough starters host yeasts and lactic‑acid bacteria that produce acid and CO₂ for rise and flavour.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Tea styles differ by oxidation/processing: green (minimal), oolong (partial), black (full), pu‑erh (post‑fermented).', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Chocolate tempering sets stable cocoa‑butter crystals (Form V) for snap and gloss.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Capsaicin binds TRPV1 receptors to create chili heat; dairy casein helps dissolve it, water does not.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Brining meat in saltwater denatures proteins and improves moisture retention during cooking.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Baking powder is often double‑acting: one reaction when wet, another in oven heat.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Proofing bread too long (over‑proofing) collapses structure and reduces oven spring.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Coffee extraction sweet spot is often around 18–22% yield; water near 90–96 °C works for most methods.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Hard water can mute coffee flavour; many cafés target ~50–175 ppm hardness and proper alkalinity.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Pressure cookers raise the boiling point of water, speeding braises and legumes while tenderising.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Collagen converts to gelatin with low‑and‑slow cooking, giving meats a silky texture.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'“Searing seals in juices” is a myth; it adds flavour via browning but moisture depends on cooking time/temperature.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Honey is not recommended for infants under one year due to botulism risk.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Cooked rice should be cooled quickly and kept cold to avoid Bacillus cereus growth before reheating.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Freezing halts microbial growth but does not sterilise food; safe thawing matters.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Fermented cocoa beans are dried and roasted before grinding into chocolate liquor.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Wine “legs” are due to alcohol‑water surface‑tension effects (Marangoni), not quality.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Best‑before indicates quality; use‑by indicates safety—heed use‑by dates on perishable foods.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Egg yolks can form a green ring from iron‑sulfur compounds when overcooked or cooled too slowly.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Adding salt early draws out moisture in vegetables (osmosis) and deepens flavour integration.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Cold‑fermented pizza dough (24–72 h) develops flavour as enzymes break down starches.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Oil-in-water emulsions like mayonnaise are stabilised by emulsifiers such as lecithin in egg yolk.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Lagrange points are areas where gravity and orbital motion balance; JWST orbits Sun–Earth L2 in a halo orbit.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Trojan asteroids share a planet’s orbit at the stable L4 and L5 points; Jupiter hosts vast swarms.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Kessler syndrome describes cascading orbital debris collisions that could render orbits unusable.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Hohmann transfer orbits minimize fuel for transfers between circular orbits of different radii.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Gravity assists change a spacecraft’s speed and direction by exchanging momentum with a planet.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Specific impulse (Isp) measures rocket efficiency in seconds; higher Isp yields more Δv per propellant.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Tsiolkovsky’s rocket equation links achievable Δv to exhaust velocity and the mass ratio of the rocket.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Geostationary orbits are a special case of geosynchronous: zero inclination and circular over the equator.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Sunspots are cooler magnetic regions; the Sun’s magnetic polarity flips about every 11 years (full cycle ~22).', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Auroras form when charged particles follow magnetic field lines into the upper atmosphere and excite gases.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Mercury is locked in a 3:2 spin–orbit resonance: three rotations for every two orbits.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Many close‑in exoplanets are tidally locked, showing one face to their star.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'The radial‑velocity method detects exoplanets by stellar Doppler shifts from gravitational wobbles.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Gravitational microlensing can reveal distant exoplanets when a foreground star briefly magnifies a background star.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Transit timing variations (TTVs) can uncover additional planets in multi‑planet systems.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Type Ia supernovae act as “standard candles” for measuring cosmic expansion.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Cepheid variables follow a period–luminosity relation (Leavitt''s law) used for distance scaling.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'The Earth–Moon system orbits a barycenter located ~4,700 km from Earth’s center, still inside Earth.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Enceladus vents water‑rich plumes that feed Saturn’s E ring and contain salts and organics.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Europa likely harbors a global subsurface ocean kept liquid by tidal heating.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Comets have two main tails: a straight ion tail and a curved dust tail; both point generally away from the Sun.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Asteroids are mostly rocky/metallic; comets contain more ices and develop comae/tails when heated.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Pulsars are rotating neutron stars with lighthouse‑like beams; their stability makes them cosmic clocks.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Gamma‑ray bursts are among the most energetic events, linked to massive star collapse or neutron‑star mergers.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Redshift has cosmological, Doppler, and gravitational components depending on the source of wavelength stretch.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Deodorise carpets by sprinkling baking soda, leave 15–30 minutes, then vacuum thoroughly.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Clean a washing machine: run a hot empty cycle with white vinegar, wipe the door gasket and clean the filter.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Deep‑clean a dishwasher: place a cup of vinegar on the top rack and run hot; clear food from the filter and spray arms.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Refresh tired towels: wash once with a cup of white vinegar (no detergent), then again with ½ cup baking soda.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Remove light rust from hand tools by soaking in vinegar or citric acid, scrubbing, drying, then oiling lightly.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Buff stainless steel with a drop of mineral oil on a microfibre cloth to reduce fingerprints after cleaning.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Clean an iron''s soleplate with a paste of baking soda and water; avoid steam holes; wipe and run on scrap cloth.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Fill small nail holes in painted walls with ready‑mixed filler; smooth, let dry, and touch up paint.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Fix a wobbly table by shimming the short leg with a trimmed cork coaster or cardboard.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Remove musty odours from books by sealing them in a box with baking soda or charcoal overnight (not on pages).', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Keep tall boots upright by inserting cut pieces of foam pool noodle inside each boot.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'When painting doors, loop a rubber band over both knobs across the latch to keep it from catching the jamb.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Use binder clips at the desk edge as cable catches to stop cords slipping off.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Chill wine without dilution by using frozen grapes as ice cubes.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Soften hardened brown sugar by microwaving it 20–30 seconds with a damp paper towel (short‑term fix).', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Freshen kitchen drains by flushing with hot water and citrus peels (if you have a disposal) or boiling water and soap.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Improve radiator efficiency by placing reflective foil behind it (do not cover vents).', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Clean window tracks with an old toothbrush and vacuum; finish with cotton buds and mild cleaner.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Punch small holes in a paint‑tin rim channel so excess paint drains back instead of pooling.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Label cords with bread‑bag tags or masking tape folded around the cable near the plug.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Use a lint roller to dust fabric lamp shades quickly.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Brighten grout with an oxygen‑bleach solution (per label), scrub gently, rinse; test on a small area first.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Wash a mildewed shower curtain with baking soda and a few towels for scrubbing action, then rinse with vinegar.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Lubricate sticky wooden drawers by rubbing the runners with candle wax or a dry bar of soap.', GETDATE(), NULL, 0, 0),
(@Cat_DIY, N'Keep screws and small parts corralled by spreading a magnetic tray or a strip of painter’s tape sticky‑side up.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Consistent hashing spreads keys across nodes and minimizes remapping when nodes join or leave.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Merkle trees let systems verify large data sets efficiently and are core to blockchains and content-addressed storage.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Log-structured merge trees (LSM) favor fast writes and later compaction of sorted runs (SSTables).', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Columnar formats like Parquet/ORC compress well and accelerate scans for analytics.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Vectorized execution processes data in batches to improve CPU cache locality and throughput.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Cache eviction policies include LRU, LFU, ARC, and TinyLFU for high hit rates under skewed traffic.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Exponential backoff with jitter reduces contention and thundering-herd effects during retries.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The circuit breaker pattern trips on repeated failures to prevent cascading outages.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The Saga pattern coordinates distributed transactions with compensating actions.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'OAuth 2.0 defines grant types; OpenID Connect adds an identity layer with ID tokens.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'WebAuthn/FIDO2 uses public‑key cryptography for phishing‑resistant sign‑in without shared secrets.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'HTTP caching uses Cache‑Control, ETag, and Last‑Modified headers for freshness and validation.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Idempotency keys in APIs prevent duplicate effects when clients retry requests.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Kafka stores ordered logs in partitions; consumers track offsets for scalable streaming.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Exactly‑once processing in streams is achieved via idempotent producers and transactional sinks.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'CRDTs enable conflict‑free merges for eventually consistent, offline‑first data.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Cuckoo filters are space‑efficient like Bloom filters but support deletions.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'HyperLogLog estimates distinct counts using tiny fixed memory with small error.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Count‑Min Sketch approximates item frequencies with controlled overestimation.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Data‑lake table formats (Delta Lake/Iceberg/Hudi) add ACID transactions atop Parquet.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Columnar engines use encodings (dictionary, run‑length, bit‑packing) to compress and speed scans.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Branch prediction reduces pipeline stalls; mispredictions cost cycles on deep pipelines.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'NUMA systems have faster access to local memory; thread pinning can reduce latency.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'NVMe uses PCIe for low‑latency storage access compared with SATA/SAS.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'TLS session resumption and 0‑RTT cut handshake latency; 0‑RTT data can be replayed unless guarded.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'CRISPR–Cas9 uses a guide RNA and the Cas9 nuclease to cut DNA at chosen sequences for genome editing.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'PCR amplifies DNA by cycling temperatures and using a thermostable DNA polymerase like Taq.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'DNA replication is semiconservative: each daughter helix contains one original strand and one new strand.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Mitochondria generate most cellular ATP via oxidative phosphorylation driven by a proton gradient.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Ribosomes translate mRNA into proteins in the cytosol and on the rough endoplasmic reticulum.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The genetic code uses 64 codons to encode 20 amino acids plus start and stop signals.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'GC base pairs have three hydrogen bonds while AT pairs have two, influencing DNA stability.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Enantiomers are mirror-image molecules; in biology, most amino acids are L-forms and sugars are D-forms.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Hemoglobin shows cooperative oxygen binding, producing a sigmoidal saturation curve.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Prions are infectious proteins that induce misfolding of normal proteins, causing neurodegenerative disease.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Telomeres cap chromosome ends and typically shorten with each cell division in somatic cells.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Bacteria share genes by horizontal transfer: transformation, transduction, and conjugation.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Helium-4 becomes a superfluid near 2.17 K and can flow without viscosity through tiny channels.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Heisenberg’s uncertainty principle limits simultaneous precision of position and momentum.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Quantum entanglement creates strong correlations that do not enable faster-than-light communication.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'In 2015, LIGO made the first direct detection of gravitational waves from merging black holes.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Trillions of neutrinos pass through your body each second with vanishingly few interactions.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The cosmic microwave background is relic radiation at ~2.7 K left from the early universe.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Photosynthesis releases oxygen by splitting water in the light reactions, not from CO₂.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Most proton and neutron mass arises from gluon field energy rather than quark rest mass.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Quarks occur in six “flavors”: up, down, charm, strange, top, and bottom.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Lasers emit coherent light via stimulated emission in a gain medium bounded by a resonator.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Quantum superposition lets systems exist in combinations of states until measurement.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'An acid’s strength is quantified by pKₐ; a lower pKₐ indicates a stronger acid.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Isotopes are atoms with the same number of protons but different numbers of neutrons.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Sound travels faster in liquids and solids than in gases because particles are closer together.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Human stomach acid typically has a pH between about 1 and 3.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Osmosis is water diffusion across a semipermeable membrane toward higher solute concentration.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'DNA repair pathways such as mismatch repair and nucleotide excision repair fix many errors.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'RNA interference uses small RNAs (siRNA, miRNA) to silence gene expression post-transcriptionally.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Many enzymes require coenzymes such as NAD⁺ or FAD to shuttle electrons in metabolism.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'ATP synthase makes ATP by harnessing a transmembrane proton-motive force.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'X-ray crystallography infers atomic structure from diffraction patterns of crystalline samples.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The Hubble–Lemaître law states galaxy recessional velocity increases roughly with distance.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Kepler’s first law: planets orbit the Sun in ellipses with the Sun at one focus.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Earth’s ocean tides arise mainly from the Moon’s gravity producing differential forces.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Brown adipose tissue generates heat by uncoupling oxidative phosphorylation via UCP1.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Mammalian circadian rhythms are coordinated by the suprachiasmatic nucleus and light cues.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Bird lungs use air sacs for near-unidirectional airflow, enabling efficient gas exchange.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The genetic code is nearly universal with small deviations in mitochondria and some microbes.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Bacteriophages are viruses that infect bacteria and are abundant in marine ecosystems.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The elementary charge e is about 1.602×10⁻¹⁹ coulomb; it is the magnitude of electron charge.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Planck’s constant h ≈ 6.626×10⁻³⁴ J·s sets the scale of quantum phenomena.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'A blackbody spectrum depends only on temperature; the peak wavelength follows Wien’s law.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'When CO₂ dissolves in water it forms carbonic acid, an important buffer in blood chemistry.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'RNA viruses mutate rapidly because their polymerases lack robust proofreading.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Antibiotics target bacterial-specific processes (e.g., cell walls, 70S ribosomes).', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Allosteric regulation alters enzyme activity when effectors bind sites other than the active site.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Gibbs free energy (ΔG) predicts spontaneity at constant temperature and pressure; ΔG < 0 favors progress.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'TCP provides reliable, ordered, byte-stream delivery; UDP is connectionless and best-effort.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'DNS resolves domain names to IP addresses using a distributed, cached hierarchy of name servers.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'IPv6 uses 128-bit addresses, vastly expanding the address space beyond IPv4’s 32-bit limits.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'TLS underpins HTTPS by encrypting traffic and authenticating servers via digital certificates.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Content Delivery Networks (CDNs) reduce latency by caching content at edge servers near users.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Containers bundle apps with dependencies and share the host OS kernel; VMs emulate full hardware.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Kubernetes orchestrates containers, handling scheduling, autoscaling, and self-healing restarts.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'CI/CD pipelines automate building, testing, and deploying changes for faster, safer releases.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The CAP theorem: in the presence of partitions, a system must choose between strong consistency and availability.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'ACID transactions ensure atomicity, consistency, isolation, and durability in databases.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Event-driven architectures react to messages and events rather than tightly coupled calls.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Idempotent API operations can be retried safely because repeated calls produce the same effect.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Indexes (e.g., B-trees) accelerate reads at the cost of extra storage and slower writes/updates.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Sharding partitions data across nodes to scale write throughput and storage capacity.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Replication keeps multiple synchronized copies for high availability and read scaling.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Bloom filters provide fast probabilistic membership tests with possible false positives.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'MapReduce models large-scale data processing as parallel map and reduce phases.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Inverted indexes map terms to posting lists of documents and power full-text search.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'UTF-8 encodes Unicode in one to four bytes and is backward-compatible with ASCII.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Unicode normalization (NFC/NFD/NFKC/NFKD) affects how equivalent text compares and stores.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'WebSockets enable full-duplex communication between browsers and servers over a single TCP connection.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'REST treats resources as addressable URIs and uses stateless HTTP methods to manipulate them.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'GraphQL lets clients request precisely the fields they need in a single query against a schema.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'gRPC uses Protocol Buffers over HTTP/2 to implement efficient remote procedure calls.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Consensus algorithms like Paxos and Raft let distributed nodes agree on a sequence of operations.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Algorithmic time complexity describes scaling; O(n log n) is typical for comparison-based sorting.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'SSD controllers perform wear leveling and garbage collection to extend flash lifespan.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'RAID 1 mirrors data; RAID 5 stripes with parity; RAID 0 stripes without redundancy.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'GPUs excel at data-parallel workloads with thousands of simple cores and high memory bandwidth.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'SIMD vector instructions operate on multiple data elements per instruction to boost throughput.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'RISC CPUs use simple, uniform instructions; CISC CPUs support complex, variable-length ones.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'ARM big.LITTLE pairs performance and efficiency cores to balance speed with battery life.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Bluetooth Low Energy targets short-range, low-power links; Wi‑Fi targets higher bandwidth and range.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'NFC uses inductive coupling at 13.56 MHz for contactless cards, tags, and device pairing.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Edge computing processes data near its source to reduce latency and bandwidth usage.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'WebAssembly executes near-native code in the browser for performance-critical components.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Progressive Web Apps (PWAs) use Service Workers for offline support and background sync.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'TLS 1.3 removes legacy ciphers and reduces handshake round trips for faster secure connections.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'HTTP/2 multiplexes streams over one TCP connection; HTTP/3 uses QUIC over UDP to cut head-of-line blocking.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Zero-knowledge proofs let someone prove a statement is true without revealing the secret itself.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Homomorphic encryption allows computations to be performed directly on encrypted data.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Hash tables map keys to buckets via a hash function to achieve average O(1) lookups.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Distributed ledgers use consensus and cryptography to order transactions without a central clock.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Differential privacy injects calibrated noise so aggregate results hide any one individual.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Feature stores maintain curated ML features for consistent training and real-time serving.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Transformer neural networks rely on self-attention to capture long-range dependencies.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Quantization compresses ML models by lowering numeric precision (e.g., FP32→INT8) with small accuracy loss.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Vector databases index embeddings for approximate nearest-neighbor similarity search.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Backpressure mechanisms slow producers when consumers or queues become overloaded.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Dynamic voltage and frequency scaling (DVFS) reduces CPU/GPU power use during light workloads.', GETDATE(), NULL, 0, 0),
...
(@Cat_Health, N'The human brain uses about 20% of the body''s total energy despite being only 2% of body weight.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Water expands by about 9% when it freezes, which is why ice floats on water.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The Great Wall of China is not visible from space without aid, contrary to popular belief.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The first computer bug was an actual moth found in a Harvard Mark II computer in 1947.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Octopuses have three hearts and blue blood.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'A day on Venus is longer than its year because Venus rotates very slowly in the opposite direction.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Bananas are berries in botanical terms, while strawberries are not.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Honey found in ancient tombs can still be edible because it is naturally low in water and acidic.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'The Eiffel Tower gets slightly taller in summer due to thermal expansion of its metal.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Wombats produce cube-shaped droppings that help keep them from rolling away.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'The Moon is slowly drifting away from Earth by a few centimeters each year.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Butterflies can taste using sensors on their feet.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'The International Space Station orbits Earth about sixteen times each day.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Saturn is less dense than water, so a hypothetical planet-sized bathtub could make it float.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'Rainbows are actually full circles; from the ground we usually see only an arc.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'The word "robot" comes from the Czech "robota," meaning forced labor.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Peanuts are legumes, not true nuts.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Copper surfaces naturally kill many microbes through a process called contact killing.', GETDATE(), NULL, 0, 0),
(@Cat_General, N'The only letter not found in the name of any U.S. state is Q.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'In seahorses, the males carry the pregnancy and give birth.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Mars has two small moons named Phobos and Deimos.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'The Great Barrier Reef is the largest living structure on Earth.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Tardigrades, or water bears, can survive extreme conditions by entering a tun state.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Hummingbirds can hover and even fly backward.', GETDATE(), NULL, 0, 0),
(@Cat_Math, N'Sunflower seed patterns often follow Fibonacci spirals.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Polar bears have black skin beneath their white fur.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'A Martian day, called a sol, is about 24 hours and 39 minutes long.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Jupiter''s Great Red Spot is a giant storm larger than Earth.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Sound cannot travel through the vacuum of space because there is no medium.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Pineapples are multiple fruits formed when many flowers fuse together.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Some freshwater turtles can absorb oxygen through their cloaca when underwater.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'Lightning can strike the same place more than once.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'The Dead Sea is so salty that people float easily on its surface.', GETDATE(), NULL, 0, 0),
(@Cat_Health, N'The smallest bone in the human body is the stapes in the middle ear.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Cheetahs cannot roar like lions and tigers; they purr instead.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'A comet''s tail always points away from the Sun due to solar wind and radiation pressure.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'Antarctica is the largest desert on Earth by area.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Bats are the only mammals capable of sustained flight.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Frogs absorb water through their skin rather than drinking with their mouths.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'By weight, spider silk can be stronger than steel.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Tigers have striped skin as well as striped fur.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Orcas, or killer whales, are the largest members of the dolphin family.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Sunlight takes about eight minutes to reach Earth.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'Earth''s rotation is gradually slowing down, making days slightly longer over long timescales.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Crows can recognize human faces and remember how people treat them.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Dolphins use unique signature whistles that function like names.', GETDATE(), NULL, 0, 0),
(@Cat_History, N'Potatoes were first domesticated in the Andes of South America.', GETDATE(), NULL, 0, 0),
(@Cat_History, N'Carrots were commonly purple before orange varieties became popular in Europe.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Coast redwoods are among the tallest trees on Earth.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'The Sahara Desert was once greener, with lakes and grasslands in the distant past.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Olympus Mons on Mars is the tallest known volcano in the solar system.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Venus has thick clouds of sulfuric acid and a runaway greenhouse effect.', GETDATE(), NULL, 0, 0),
(@Cat_Health, N'An adult human skeleton typically has 206 bones.', GETDATE(), NULL, 0, 0),
(@Cat_Health, N'Cracking your knuckles has not been shown to cause arthritis.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'Dust from the Sahara helps fertilize the Amazon rainforest across the Atlantic.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Coffee beans are the seeds of a fruit commonly called a coffee cherry.', GETDATE(), NULL, 0, 0),
(@Cat_FoodDrink, N'Cinnamon is made from the inner bark of trees in the genus Cinnamomum.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'The word "alphabet" comes from the first two Greek letters: alpha and beta.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The first retail product scanned with a barcode in 1974 was a pack of chewing gum.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The first 3D printer was developed in the 1980s using a process called stereolithography.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'The word "emoji" comes from Japanese and is unrelated to the English word "emotion."', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'LEGO bricks made in 1958 still interlock with modern bricks because the design has stayed consistent.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Velcro was inspired by burrs that stuck to clothing and a dog''s fur, observed by Georges de Mestral.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Bubble wrap was originally invented as a textured wallpaper before becoming packing material.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'Percy Spencer discovered microwave heating when a candy bar melted near a magnetron, leading to the microwave oven.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Honeybees communicate the location of flowers using a waggle dance.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Leafcutter ants cultivate fungi as their primary food source.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Fireflies produce light through a chemical reaction called bioluminescence.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'The platypus is one of the few mammals that lays eggs.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'The Amazon River carries more water than any other river in the world.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'The Andean condor has one of the largest wingspans of any land bird.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'The Andes is the longest continental mountain range on Earth.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'The Himalayas are still rising due to the collision of tectonic plates.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'Hawaii moves northwest a few centimeters each year because it sits on a moving tectonic plate.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'A "Blue Moon" commonly refers to the second full moon in a single calendar month.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'The dot above the letters i and j is called a tittle.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'The # symbol is also called an octothorpe.', GETDATE(), NULL, 0, 0),
(@Cat_Language, N'A palindrome reads the same forward and backward, like "racecar."', GETDATE(), NULL, 0, 0),
(@Cat_General, N'U.S. paper currency is primarily a blend of cotton and linen rather than wood pulp.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'The International Space Station is the largest human-made object in low Earth orbit.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Termites are more closely related to cockroaches than to ants.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Koalas have fingerprints so similar to humans that they can confuse forensic analysis.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Giraffes and humans both have seven neck vertebrae despite their different neck lengths.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'A group of flamingos is called a flamboyance.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Male pufferfish create intricate sand circles on the seafloor to attract mates.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Monarch butterflies migrate thousands of kilometers between North America and Mexico.', GETDATE(), NULL, 0, 0),
(@Cat_Math, N'A leap year helps keep the calendar aligned with Earth''s orbit around the Sun.', GETDATE(), NULL, 0, 0),
(@Cat_Science, N'Mercury is the only metal that is liquid at standard room temperature and pressure.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Glass frogs have transparent skin on their bellies that reveals their internal organs.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Sharks appear in the fossil record before trees existed.', GETDATE(), NULL, 0, 0),
(@Cat_Geography, N'The deepest part of the ocean is the Challenger Deep in the Mariana Trench.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'Polaris will not always be the North Star because Earth''s axis slowly wobbles over time.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Many lizards can shed their tails to escape predators and later regenerate them.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Plants like the Venus flytrap capture insects to supplement scarce nutrients.', GETDATE(), NULL, 0, 0),
(@Cat_Health, N'The brain itself has no pain receptors; headaches arise from surrounding tissues and blood vessels.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'The ostrich is the tallest living bird and lays the largest eggs of any bird.', GETDATE(), NULL, 0, 0),
(@Cat_ArtsCulture, N'A piano is considered both a string instrument and a percussion instrument.', GETDATE(), NULL, 0, 0),
(@Cat_Tech, N'The modern internet traces its roots to ARPANET, a project started in the late 1960s.', GETDATE(), NULL, 0, 0),
(@Cat_Space, N'GPS satellites must account for relativity because time runs slightly differently in orbit.', GETDATE(), NULL, 0, 0),
(@Cat_EarthScience, N'A cloud can weigh many tons because it contains vast numbers of tiny water droplets.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Mango trees are in the same plant family as cashews and pistachios.', GETDATE(), NULL, 0, 0),
(@Cat_Plants, N'Tomatoes are fruits botanically but are often treated as vegetables in cooking.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Seahorses have prehensile tails that help them anchor to seagrass and corals.', GETDATE(), NULL, 0, 0),
(@Cat_Animals, N'Snakes collect scent particles on their tongues and deliver them to Jacobson''s (vomeronasal) organ to "smell."', GETDATE(), NULL, 0, 0),
